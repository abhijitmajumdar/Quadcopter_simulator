...
def Single_AI():
    ...
    ctrl = controller.Controller_AI(quad.get_state,quad.get_time,quad.set_motor_speeds,params=CONTROLLER_PARAMETERS,quad_identifier='q1')
    # Start the threads
